...
#
# Modifications (c) 2026 Łukasiewicz – PIT, distributed as part
# of the FieldForge project (see LICENSE, GPL-3.0-or-later).
...
class Extension(omni.ext.IExt):
    def on_startup(self, ext_id: str):
        ...
        self._window = ScrollingWindow(
            title=TITLE, width=600, height=500, visible=False, dockPreference=ui.DockPreference.LEFT_BOTTOM
        )
        self._window.set_visibility_changed_fn(self._on_window)

        # 1. THE SAFE ACTION REGISTRY
        ...
        # 2. USING onclick_action INSTEAD OF onclick_fn
        self._menu_items = [
            MenuItemDescription(
                name=TITLE, 
